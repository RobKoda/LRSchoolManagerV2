...
namespace LRSchoolV2.Email.Emails.CustomerQuote;

public class CustomerQuoteEmail : EmailMessage
{
    public CustomerQuoteEmail(string inQuoteNumber) // Formerly Domain.CustomerInvoices.CustomerInvoice inCustomerInvoice
    {
