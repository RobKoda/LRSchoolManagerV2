...
namespace LRSchoolV2.Email.Emails.ConsultantInvoice;

public class ConsultantInvoiceEmail : EmailMessage
{
    public ConsultantInvoiceEmail(string inInvoiceNumber)
    {
